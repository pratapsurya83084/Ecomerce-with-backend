...
function DashboardTab() {
  ...
  const { mode ,product,edithandel,UpdateProduct,deleteProduct} = context;
    ...
    <>
      <div className="container mx-auto">
        <div className="tab container mx-auto ">
          {/* tabs parents of all tab  used to change small change of the page /component */}
         {/* it can show 1st index data i.e zero index */}
            ...
            <TabPanel>
             ...
             <div className=" flex justify-end">
                ...
                <div className="relative overflow-x-auto ">
                  ...
                  {
                    product.map((val,i)=>{
                      const {title,price,imageUrl,category,description,date}=val;
                     return(
